#!/Users/Ruben/Desktop/airflow-project-2/venv/bin/python3.7
# -*- coding: utf-8 -*-
...
class datacatalogCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'get_taxonomy': ('name', ),
        'import_taxonomies': ('parent', 'inline_source', 'cross_regional_source', ),
        ...
        'modify_entry_contacts': ('name', 'contacts', ),
        'modify_entry_overview': ('name', 'entry_overview', ),
